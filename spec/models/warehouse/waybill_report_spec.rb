...
describe Warehouse::WaybillReport do
  ...
  it 'should sort waybills with resources' do
    ...
    wbs = Warehouse::WaybillReport.order_by(field: 'created', type: 'asc').all
    wbs_test = Warehouse::WaybillReport.order('created').all
    wbs.should eq(wbs_test)
    wbs = Warehouse::WaybillReport.select_all.with_resources.order_by(field: 'created', type: 'desc').all
    wbs_test = Warehouse::WaybillReport.select_all.with_resources.order('created DESC').all
    wbs.should eq(wbs_test)

    wbs = Warehouse::WaybillReport.select_all.with_resources.order_by(field: 'document_id', type: 'asc').all
    wbs_test = Warehouse::WaybillReport.select_all.with_resources.order('document_id').all
    wbs.should eq(wbs_test)
    wbs = Warehouse::WaybillReport.select_all.with_resources.order_by(field: 'document_id', type: 'desc').all
    wbs_test = Warehouse::WaybillReport.select_all.with_resources.order('document_id DESC').all
    wbs.should eq(wbs_test)

    wbs = Warehouse::WaybillReport.select_all.with_resources.order_by(field: 'distributor', type: 'asc').all
    wbs_test = Warehouse::WaybillReport.joins{deal.rules.from.entity(LegalEntity)}.
        order('legal_entities.name').all
    wbs.should eq(wbs_test)
    wbs = Warehouse::WaybillReport.order_by(field: 'distributor', type: 'desc').all
    wbs_test = Warehouse::WaybillReport.joins{deal.rules.from.entity(LegalEntity)}.
        order('legal_entities.name DESC').all
    wbs.should eq(wbs_test)

    wbs = Warehouse::WaybillReport.order_by(field: 'storekeeper', type: 'asc').all
    wbs_test = Warehouse::WaybillReport.joins{deal.entity(Entity)}.order('entities.tag').all
    wbs.should eq(wbs_test)
    wbs = Warehouse::WaybillReport.order_by(field: 'storekeeper', type: 'desc').all
    wbs_test = Warehouse::WaybillReport.joins{deal.entity(Entity)}.order('entities.tag DESC').all
    wbs.should eq(wbs_test)

    wbs = Warehouse::WaybillReport.order_by(field: 'storekeeper_place', type: 'asc').all
    wbs_test = Warehouse::WaybillReport.joins{deal.take.place}.order('places.tag').all
    wbs.should eq(wbs_test)
    wbs = Warehouse::WaybillReport.order_by(field: 'storekeeper_place', type: 'desc').all
    wbs_test = Warehouse::WaybillReport.joins{deal.take.place}.order('places.tag DESC').all
    wbs.should eq(wbs_test)

    wbs = Warehouse::WaybillReport.select_all.with_resources.order_by(field: 'resource_tag', type: 'asc').all
    wbs_test = Warehouse::WaybillReport.select_all.with_resources.order('assets.tag').all
    wbs.should eq(wbs_test)
    wbs = Warehouse::WaybillReport.select_all.with_resources.order_by(field: 'resource_tag', type: 'desc').all
    wbs_test = Warehouse::WaybillReport.select_all.with_resources.order('assets.tag DESC').all
    wbs.should eq(wbs_test)

    wbs = Warehouse::WaybillReport.select_all.with_resources.order_by(field: 'resource_mu', type: 'asc').all
    wbs_test = Warehouse::WaybillReport.select_all.with_resources.order('assets.mu').all
    wbs.should eq(wbs_test)
    wbs = Warehouse::WaybillReport.select_all.with_resources.order_by(field: 'resource_mu', type: 'desc').all
    wbs_test = Warehouse::WaybillReport.select_all.with_resources.order('assets.mu DESC').all
    wbs.should eq(wbs_test)

    wbs = Warehouse::WaybillReport.select_all.with_resources.order_by(field: 'resource_amount', type: 'asc').all
    wbs_test = Warehouse::WaybillReport.select_all.with_resources.order('rules.rate').all
    wbs.should eq(wbs_test)
    wbs = Warehouse::WaybillReport.select_all.with_resources.order_by(field: 'resource_amount', type: 'desc').all
    wbs_test = Warehouse::WaybillReport.select_all.with_resources.order('rules.rate DESC').all
    wbs.should eq(wbs_test)

    wbs = Warehouse::WaybillReport.select_all.with_resources.order_by(field: 'resource_price', type: 'asc').all
    wbs_test = Warehouse::WaybillReport.select_all.with_resources.order('resource_price').all
    wbs.should eq(wbs_test)
    wbs = Warehouse::WaybillReport.select_all.with_resources.order_by(field: 'resource_price', type: 'desc').all
    wbs_test = Warehouse::WaybillReport.select_all.with_resources.order('resource_price DESC').all
    wbs.should eq(wbs_test)

    wbs = Warehouse::WaybillReport.select_all.with_resources.order_by(field: 'resource_sum', type: 'asc').all
    wbs_test = Warehouse::WaybillReport.select_all.with_resources.order("resource_sum").all
    wbs.should eq(wbs_test)
    wbs = Warehouse::WaybillReport.select_all.with_resources.order_by(field: 'resource_sum', type: 'desc').all
  ...
  it 'should filter waybills with resources' do
    ...
    wbs = Warehouse::WaybillReport.select_all.with_resources.search('state' => '1').all
